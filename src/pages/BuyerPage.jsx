...
//           {buyerItems.length === 0 ? (
//             <div className="rounded-2xl bg-white px-5 py-12 text-center shadow-sm sm:px-8">
//               <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-blue-50 text-blue-600 sm:h-20 sm:w-20">
//                 <Database size={28} className="sm:h-8 sm:w-8" />
//               </div>
...
//                       src={item.heroImage}
//                       alt={item.title}
//                       className="h-28 w-full object-cover sm:h-32 md:h-36 lg:h-32"
//                     />
...
//                     <h2 className="line-clamp-2 min-h-[40px] text-[13px] font-bold leading-5 text-[#0f172a] sm:text-[14px]">
//                       {item.title}
//                     </h2>

//                     <p className="mt-2 line-clamp-2 min-h-[40px] text-[11px] leading-5 text-gray-500 sm:text-[12px]">
//                       {item.description}
//                     </p>

//                     <div className="mt-3 flex items-center gap-2">
//                       <span className="text-[15px] font-bold text-[#0f172a] sm:text-[17px]">
//                         ₹ {item.price}
//                       </span>
...
//                       <button
//                         onClick={() => navigate(`/dataset/${item.slug}`)}
//                         className="inline-flex items-center justify-center gap-2 rounded-xl bg-black py-2.5 text-[12px] font-semibold text-white"
//                       >
//                         <Eye size={14} />
//                         View
//                       </button>
...
//                       <button
//                         onClick={() => handleDownload(item)}
//                         className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-300 py-2.5 text-[12px] font-semibold text-slate-700"
//                       >
//                         <Download size={14} />
//                         Download
//                       </button>
...
import { useEffect, useState } from "react";
import { useLocation, useNavigate } from "react-router-dom";
import { Database, Download, ArrowLeft, Eye } from "lucide-react";
          ...
          {buyerItems.length === 0 ? (
            <div className="rounded-2xl bg-white px-5 py-12 text-center shadow-sm sm:px-8">
              ...
              <button
                type="button"
                onClick={() => navigate("/")}
                className="mt-8 inline-flex items-center gap-2 rounded-xl bg-red-600 px-5 py-3 text-sm font-semibold text-white"
              >
                <ArrowLeft size={18} />
                Continue Shopping
              </button>
                ...
                >
                  <div className="relative">
                    <img
                      src={item.heroImage}
                      alt={item.title}
                      className="h-32 w-full object-cover sm:h-36 md:h-40 lg:h-36 xl:h-40"
                    />

                    {item.discount && (
                      <span className="absolute left-0 top-2 rounded-r-lg bg-orange-500 px-2 py-1 text-[9px] font-semibold text-white sm:text-[10px]">
                        {item.discount}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="p-2.5 sm:p-3">
                    <div className="mb-2 flex flex-wrap gap-1">
                      <span className="rounded-full bg-blue-50 px-2 py-1 text-[9px] font-semibold text-blue-600 sm:text-[10px]">
                        {item.category}
                      </span>
                      <span className="rounded-full bg-emerald-50 px-2 py-1 text-[9px] font-semibold text-emerald-700 sm:text-[10px]">
                        Purchased
                      </span>
                    </div>

                    <h2 className="line-clamp-2 min-h-[36px] text-[12px] font-bold leading-4 text-[#0f172a] sm:text-[13px]">
                      {item.title}
                    </h2>

                    <p className="mt-1.5 line-clamp-2 min-h-[34px] text-[10px] leading-4 text-gray-500 sm:text-[11px]">
                      {item.description}
                    </p>

                    <div className="mt-2.5 flex items-center gap-2">
                      <span className="text-[14px] font-bold text-[#0f172a] sm:text-[15px]">
                        ₹ {item.price}
                      </span>
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      <button
                        onClick={() => navigate(`/dataset/${item.slug}`)}
                        className="inline-flex items-center justify-center gap-1 rounded-lg bg-black px-2 py-2 text-[11px] font-semibold text-white"
                      >
                        <Eye size={12} />
                        View
                      </button>
                      ...
                      <button
                        onClick={() => handleDownload(item)}
                        className="inline-flex items-center justify-center gap-1 rounded-lg border border-slate-300 px-2 py-2 text-[11px] font-semibold text-slate-700"
                      >
                        <Download size={12} />
                        Download
                      </button>
