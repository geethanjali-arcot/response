                  ...
                  <div className="mt-6 grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        value={buyerInfo.firstName}
                        onChange={handleBuyerChange}
                        className="h-12 w-full rounded-lg border border-slate-300 px-4 text-sm outline-none focus:border-[#1d4ed8]"
                      />
                    </div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <textarea
                        ...
                        value={buyerInfo.note}
                        onChange={handleBuyerChange}
                        className="w-full rounded-lg border border-slate-300 px-4 py-3 text-sm outline-none focus:border-[#1d4ed8]"
                        placeholder="Any special note or payment reference..."
                      />
                    </div>
                  </div>
                    ...
                    {paymentMethod === "bank" && (
                      <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                        ...
                        <p className="mt-2 text-sm leading-6 text-slate-600">
                          Transfer the amount and add the transaction reference
                          in the note field. After confirmation, product access
                          will be available in your profile or bought items section.
                        </p>
                      </div>
                    )}
                  </div>
                        ...
                        cartItems.map((item, index) => (
                          ...
                          >
                            ...
                            <p className="text-sm font-bold text-[#1d4ed8]">
                              ₹ {(getNumericPrice(item.price) * (item.quantity || 1)).toFixed(2)}
                            </p>
                          </div>
                        ))
                      ) : (
